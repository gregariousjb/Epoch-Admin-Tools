...
// Admin only menu
	...
	EAT_adminMenu = EAT_adminMenu + [["Point to Delete(Perm)",[],"", -5,[["expression",format[_EXECgenTools,"PointToDelete.sqf"]]],"1","1"]];
...
// Menu for teleport options
	...
	EAT_teleportMenu = EAT_teleportMenu + [["Teleport (F7)",[],"", -5,[["expression", format[_EXECgenTools,"Teleport\Teleport.sqf"]]], "1", "1"]];
