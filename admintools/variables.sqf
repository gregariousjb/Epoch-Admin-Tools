...
/******************* Crates *******************/
	...
	// Backpack crate
	EAT_backpackCrateContents = [["DZ_Backpack_EP1", 1],["DZ_CivilBackpack_EP1", 1],["DZ_CompactPack_EP1", 1],["DZ_GunBag_EP1", 1],["DZ_LargeGunBag_EP1", 1]];
