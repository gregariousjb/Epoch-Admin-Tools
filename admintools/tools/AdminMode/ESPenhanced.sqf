...
{	
	...
	if (enhancedESP2 && visibleMap) then
	{
		...
		{
			crashList = allMissionObjects "UH1Wreck_DZ"	+ allMissionObjects "UH60Wreck_DZ" + allMissionObjects "UH60_NAVY_Wreck_DZ" + allMissionObjects "UH60_ARMY_Wreck_DZ" + allMissionObjects "UH60_NAVY_Wreck_burned_DZ" + allMissionObjects "UH60_ARMY_Wreck_burned_DZ" + allMissionObjects "Mass_grave_DZ" + allMissionObjects "Supply_Crate_DZE" + allMissionObjects "Su25_TK_EP1" + allMissionObjects "AV8BWreck" + allMissionObjects "AH1ZWreck" + allMissionObjects "Mi24Wreck" + allMissionObjects "Ka52Wreck" + allMissionObjects "Mi8Wreck" + allMissionObjects "A10Wreck" + allMissionObjects "MV22Wreck" + allMissionObjects "UralWreck" + allMissionObjects "HMMWVWreck" + allMissionObjects "datsun01Wreck" + allMissionObjects "hiluxWreck" + allMissionObjects "datsun02Wreck" + allMissionObjects "UAZWreck" + allMissionObjects "Land_Misc_Garb_Heap_EP1" + allMissionObjects "Fort_Barricade_EP1" + allMissionObjects "Rubbish2" + allMissionObjects "Land_wreck_cinder" + allMissionObjects "Land_wood_wreck_quarter" + allMissionObjects "Land_wood_wreck_floor" + allMissionObjects "Land_wood_wreck_third" + allMissionObjects "Land_wood_wreck_frame" + allMissionObjects "Land_iron_vein_wreck" + allMissionObjects "Land_silver_vein_wreck" + allMissionObjects "Land_gold_vein_wreck" + allMissionObjects "Land_ammo_supply_wreck";
			i2 = 0;
			{
				_name = gettext (configFile >> "CfgVehicles" >> (typeof _x) >> "displayName");
				pos = position _x;
